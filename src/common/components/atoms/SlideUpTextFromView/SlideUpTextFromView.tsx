...
import slideUpByScope from "./slideUpTextByTimeline"

import SplitType from "split-type"
import initSlideUpByTimeline from "./initSlideUpByTimeline"
...
export default function SlideUpTextFromView({
  ...
  useLayoutEffect(() => {
    ...
    let animate = gsap.context((context) => {
      ...
      initSlideUpByTimeline(timeline)
